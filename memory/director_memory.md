...
- **2026-03-12 (8.1–8.3):** Level config loader, WaveSpawner refactor, Parallax theme selector CEO signed off. Milestones were already implemented but not marked Done. Fixed 6 stale parallax tests; added 19 level-loader tests. Next: 8.4 (Level timing system).
