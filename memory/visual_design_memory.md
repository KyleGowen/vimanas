...
- **2026-03-06 (Turtle spread VFX):** Turtle secondary = spheres with same arc palette and multi-layer radial gradient. 4 layers, pulseFreq 12, shadowBlur 24–36. Keeps arc-style glow; avoid solid/crisp edge (reverted—looked bad). See src/effects/turtle-spread-effect.ts.
