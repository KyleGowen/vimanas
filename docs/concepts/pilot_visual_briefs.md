...
**Narrative Agent · Phase 1 · Visual Design · Phase 2 · MILESTONE_001 · 2025-03-01**

Visual direction for the four pilots. Feeds into Visual Design for portrait and UI artwork.
...
**Portrait direction:** "I hold the line." Unshakeable. The calm in the storm.
...
- **Ship select:** Full portrait; name and ship type below.
- **HUD icon:** Small bust (32×32 or 64×64); readable silhouette.
- **Mission brief:** Larger portrait with brief bio or quote.

---

## Asset List (for Visual Design)

| Asset | Format | Size | Notes |
|-------|--------|------|-------|
| Pilot_1_portrait | PNG | 256×256 | Speed specialist |
| Pilot_2_portrait | PNG | 256×256 | Weapon specialist |
| Pilot_3_portrait | PNG | 256×256 | Defensive specialist |
| Pilot_4_portrait | PNG | 256×256 | Neutral rookie |
| Pilot_1_icon | PNG | 32×32 | HUD icon |
| Pilot_2_icon | PNG | 32×32 | HUD icon |
| Pilot_3_icon | PNG | 32×32 | HUD icon |
| Pilot_4_icon | PNG | 32×32 | HUD icon |

---

## References

- [docs/narrative_bible.md](../narrative_bible.md) — Character definitions
- [docs/art_style_guide.md](../art_style_guide.md) — UI Style, palette
- [docs/art_style_guide.md](../art_style_guide.md) — Visual pillar
