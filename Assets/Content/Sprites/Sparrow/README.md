...
Place in `Assets/Content/Sprites/Sparrow/`. Unity will generate .meta files. For SpriteRenderer, assign `sparrow_flying_forward` as default; use others for animation or runtime swap.
